...
class _ApiService implements ApiService {
  ...
  Future<UpdateStatusDto?> updateOrderStatus(
    ...
    _data.addAll(updateStatusRequest.toJson());
    final _options = _setStreamType<UpdateStatusDto>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            'orders/order_status',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late UpdateStatusDto? _value;
    try {
      _value = _result.data == null
          ? null
          : UpdateStatusDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<OrderCompletedDto?> getOrdersCompleted() async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(_options);
    late OrderCompletedDto? _value;
    try {
      _value = _result.data == null
          ? null
          : OrderCompletedDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
